...
<div class="content-body">
	...
	<section class="card">
		<div class="card-header">
			<h4 class="card-title" data-i18n="Product Information">Product Information</h4>
		</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_name" class="form-control" data-validation-required-message="Product name needs to be at least 3 characters." minlength="3" placeholder="nombre del producto">
                                </div>
                            </div>
                        </div>
                    </div>
